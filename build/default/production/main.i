...
{ unsigned char i;
    ...
    clcd_print("     LOOP",(0xC0 + 0));
    clcd_print("    Company ",(0x90 + 0));
   _delay((unsigned long)((2000)*(20000000/4000.0)));
}
...
{ if(reset_mode==0x11)
  ...
  clcd_putch('>',(0xC0 + 0));
  if(level_no<=2)
  { clcd_print(water_levels[level_no],(0xC0 + 1));
    clcd_print(water_levels[level_no+1],(0x90 + 1));
    clcd_print(water_levels[level_no+2],(0xD0 + 1));
  }
  else if(level_no==3)
  { clcd_print(water_levels[level_no],(0xC0 + 1));
    clcd_print(water_levels[level_no+1],(0x90 + 1));
    clcd_print(water_levels[0],(0xD0 + 1));
  }
  else
  { clcd_print(water_levels[level_no],(0xC0 + 1));
    clcd_print(water_levels[0],(0x90 + 1));
    clcd_print(water_levels[1],(0xD0 + 1));
  }
...
{ if(reset_mode==0x10)
    ...
    clcd_putch('>',(0xC0 + 0));
    if(program_no<=9)
    { clcd_print(washing_prog[program_no],(0xC0 + 1));
        clcd_print(washing_prog[program_no+1],(0x90 + 1));
        clcd_print(washing_prog[program_no+2],(0xD0 + 1));
    }
    else if(program_no==10)
    {
        ...
        clcd_print(washing_prog[program_no],(0xC0 + 1));
        clcd_print(washing_prog[program_no+1],(0x90 + 1));
        clcd_print(washing_prog[0],(0xD0 + 1));
    }
    else
    {
        clcd_print(washing_prog[program_no],(0xC0 + 1));
        clcd_print(washing_prog[0],(0x90 + 1));
        clcd_print(washing_prog[1],(0xD0 + 1));
    }
